...
the_matrix.translation_cycle("0 2-5 9-7-1", 3) #we build a matrix by translation cycles...
...
for i in range(3):
	...
	for j in range(3):
		...
		t.matrix.translate(7) #we translate the matrix...
		t.matrix.transpose() #we transpose the matrix...
		t.matrix.swap_round() #we compute a swap round...
		t.add_cycle() #we add a complete new cycle...
	filename = "v0.3.0beta_" + name + "_" + str(i)
